...
**Architecture & Ownership**: Owned build-vs-buy decisions across voice, transcription, and model providers, and set the cost and reliability targets the platform runs against.
